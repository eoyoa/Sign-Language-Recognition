...
function bs(e, t) {
	...
	return n === 0 || r === 0 ? Infinity : new i(e.vectors, t.vectors, ys).getDistance() / (n + r);
}
//#endregion
...
//#endregion
export { Ss as SignMap, hs as createClassificationWorker, ms as createLandmarker, gs as createRecognizeHandler, bs as dtwDistance, ps as isValidMapData, _s as onClassificationResult };
